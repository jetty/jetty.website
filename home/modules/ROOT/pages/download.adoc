...
NOTE: Release notes are in the [.path]_VERSION.txt_ file included with the distribution and on the link:https://github.com/jetty/jetty.project/releases[GitHub Releases] page for the Jetty project.
